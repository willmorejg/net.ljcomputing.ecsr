 ...
 */
public abstract class AbstractEntityServiceImpl<T extends AbstractDomain, S extends Entity, R extends CrudRepository<S, Long>>
	...
	public List<S> readAll(Pageable page) {
		return (List<S>) Lists.newArrayList(getRepository().findAll((Iterable<Long>) page));
	}
