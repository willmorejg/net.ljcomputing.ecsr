...
import net.ljcomputing.people.repository.MailingAddressRepository;
import net.ljcomputing.people.service.PostalAddressService;
...
public class PostalAddressServiceImpl
		extends AbstractEntityServiceImpl<MailingAddress, MailingAddressEntity, MailingAddressRepository>
		implements PostalAddressService {
}
