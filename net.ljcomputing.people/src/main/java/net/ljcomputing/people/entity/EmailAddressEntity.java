...
public class EmailAddressEntity extends EmailAddress implements ContactEntity {
	...
	/** The email address. */
	@Indexed(indexType = IndexType.FULLTEXT, indexName = "emailAddressIdx")
	private String emailAddress;

	/** The indexed value. */
	@Indexed(unique = true, indexType = IndexType.FULLTEXT, indexName = "uniqueEmailAddressIdx", failOnDuplicate = true)
