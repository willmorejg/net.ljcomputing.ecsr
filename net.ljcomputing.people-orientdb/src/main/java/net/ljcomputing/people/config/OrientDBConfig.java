...
public class OrientDBConfig /*extends Neo4jConfiguration*/ {
	private static Logger logger = LoggerFactory.getLogger(OrientDBConfig.class);

	/**
	 * Instantiates a new Neo4J config.
	 */
	public OrientDBConfig() {
		logger.info("Configuring OrientDB");
	}
}
