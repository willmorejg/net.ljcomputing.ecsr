...
public class PersonalContactServiceImpl implements PersonalContactsService {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.ljcomputing.people.service.PersonalContactsService#savePersonalContacts(net.ljcomputing.people.entity.PersonalContactsEntity)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.ljcomputing.people.service.PersonalContactsService#readPersonalContactsByUuid(java.lang.String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.ljcomputing.people.service.PersonalContactsService#readPersonalContactsByUuid(java.util.UUID)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.ljcomputing.people.service.PersonalContactsService#readPersonalContacts(net.ljcomputing.people.entity.PersonEntity)
	 */
	@Transactional
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.ljcomputing.people.service.PersonalContactsService#readPersonalContacts(java.util.List)
	 */
